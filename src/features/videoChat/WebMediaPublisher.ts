interface WebMediaPublisherType {
  pc: RTCPeerConnection | null;
  apiUrl: string;
  streamUrl: string;
  publish: (stream: MediaStream, appId: string, feedId: string) => Promise<any>;
  close: () => void;
}

export function WebMediaPublisher(apiUrl: string, streamUrl: string): WebMediaPublisherType {
  const self = {} as WebMediaPublisherType;
