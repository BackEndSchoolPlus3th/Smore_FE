...
export const SSEProvider = ({ children }) => {
  ...
  const connectSSE = () => {
    ...
    eventSourceRef.current = new EventSource(import.meta.env.VITE_API_BASE_URL + "/sse/connect");
  ...
  return (
    <SSEContext.Provider value={{ events, eventSource: eventSourceRef.current }}>
      {children}
    </SSEContext.Provider>
  );
};
